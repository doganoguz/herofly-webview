...
class NowUIColors {
  ...
  static const Color homeclr = Color(0xFF1E1E1E);
  static const Color appbar = Color(0xFF282828);

  static const Color homecolorr = Color(0xFF070707);
  ...
  static const Color sari = Color(0xFFFCD240);
